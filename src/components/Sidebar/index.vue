...
<!--      <div class="menu">-->
<!--        <router-link-->
<!--          v-for="(routeItem, idx) in router"-->
<!--          :key="routeItem.path"-->
<!--          :to="routeItem.path"-->
<!--          :class="[route.path.includes(routeItem.routePathActive) ? 'button-active' : 'button']"-->
<!--          v-show="routeItem.showRoute"-->
<!--          @click="routeItem.name === 'ログアウト' && onLogout()"-->
<!--          :onmousemove="() => onMouseMove(idx)"-->
<!--          :onmouseleave="() => onMouseLeave(idx)"-->
<!--        >-->
<!--          <el-tooltip-->
<!--            :effect="!collapse ? 'dark' : 'transparent'"-->
<!--            :content="!collapse ? routeItem.name : ''"-->
...
<!--                  :is="routeItem.icon"-->
<!--                  :color="-->
<!--                    routeItem.isActive || route.path.includes(routeItem.routePathActive)-->
<!--                      ? 'white'-->
<!--                      : '#4e6b82'-->
<!--                  "-->
<!--              /></el-icon>-->
<!--              <span class="text" v-if="collapse">{{ routeItem.name }}</span>-->
<!--            </div>-->
<!--          </el-tooltip>-->
<!--        </router-link>-->
<!--      </div>-->
...
import type { RouteDefined } from "@/router/routes"
...
const router = shallowRef(routes.map((e: RouteDefined) => ({ ...e, isActive: false })))

const sidebarToggle = ref(false)
const selected = ref('Dashboard')
const page = ref('ecommerce')
const onMouseMove = (idx: number) => {
  router.value[idx].isActive = true
}

const onMouseLeave = (idx: number) => {
  router.value[idx].isActive = false
}
